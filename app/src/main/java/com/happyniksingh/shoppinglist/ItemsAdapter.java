...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.Myviewholder>{
    ...
    List<ItemsEntity>arraylist;
    private ItemsInterface listener;
    Context context;
    ...
    public Myviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mainshopitems,viewGroup,false);
        return new Myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Myviewholder myviewholder, int i) {
        final ItemsEntity shopsCart = arraylist.get(i);
        ...
        int i1=random.nextInt(254);
        GradientDrawable gradientDrawable=new GradientDrawable();
        gradientDrawable.setColor(Color.parseColor ("#"+mColors[new Random().nextInt(254)]));
        myviewholder.cardView.setBackground(gradientDrawable);
        myviewholder.textViewshopitemname.setText(shopsCart.getItems());
        ...
        myviewholder.textViewoption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.onoptioncliked(shopsCart,myviewholder.textViewoption);
            }
        });
    ...
    public void setNotes(List<ItemsEntity> list){
        this.arraylist=list;
    ...
    public void setListener(ItemsInterface listener) {
